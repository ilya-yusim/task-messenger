...
struct IServerSocket : public virtual ISocketLifecycle {
          /** \brief Bind + listen convenience for server startup.
            ...
            *  Implementations should be non-throwing and log failures internally.
            ...
            *  \return true on success, false on failure (errors logged internally).
            */
